...
def test_main1(file_name, embedding, vectordb, query_list, answer_list, batch=20, k=4):
    ...
    for query in tqdm(query_list):
        ...
        prompt = vsd_text_sum + "Based on these, what is the answer of the following question: " + query + ". Please choose one of the options (A, B, C, or D). No explanation." #replace
