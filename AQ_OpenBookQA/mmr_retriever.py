...
def test_main2(file_name, embedding, vectordb, query_list, answer_list, k=4, lambda_mult=0.5):
    ...
    for query in tqdm(query_list):
        ...
        prompt = mmr_text_sum + "Based on these, what is the answer of the following question: " + query + ". Please choose one of the options (A, B, C, or D). No explanation." #replace
